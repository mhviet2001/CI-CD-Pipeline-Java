...
<!-- Main style for a primary marketing message or call to action -->
<div class="style">
    <div class="container">
        <h1>Hello</h1>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h2>Nexus</h2>
            <p>Nexus3 as maven repository manager. Jenkins will publish the artifacts to Nexus after successful build </p>
            <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4">
            <h2>Ansible</h2>
